...
public:
    AppTheme(const QString &id, QObject *parent = nullptr);
    ~AppTheme() override;
...
protected:
    AppTheme(AppTheme *originTheme, QObject *parent = nullptr);
    AppThemePrivate *d;

private:
    friend AppTheme *creatorTheme();
    friend AppTheme *proxyTheme();
